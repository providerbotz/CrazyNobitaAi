# ==============================================
# PROJECT NAME - CRAZYNOBITAAI
# INTRO - AN GEMINI AI BASED API CREATING PROJECT FOR BEGGAINERS :)
# POWERED BY @PROVIDERBOTZ& BIZF
# ==============================================
...
# ==============================================
# IF MAIN API DONT GIVE OUTPUTS THEN ITS SHOW 
# ==============================================
    if not scraped:
        return {
            'success': False,
...
# ==============================================
# IF ALL ARE SET THEN THESE OUTPUTS SHOWING
# ==============================================
        if result:
            return {
                'success': True,
...
# ==============================================
# ARE URL - https://crazynobitaai/  THEN THESE MSG SHOWING 
# ==============================================
@app.route('/')
def home():
    return jsonify({
        'success': True,
        'message': 'Nobita Gemini AI API is running!',
        'update_channel': '@ProviderBotz',
        'endpoints': {
            '/crazy/nobita': {
                'method': 'GET',
                ...
                'example': '/crazy/nobita?prompt=Hello, how are you?'
            }
        },
        'documentation': {
            'description': 'Google Gemini Realtime AI By @CrazyNobita',
            'version': '5.0.0',
            'github': 'https://github.com/providerbotz'
        }
    })
# ============================================================================================
# THSE IS THE API CORRECT URL - https://crazynobitaai/crazy/nobita?prompt=What+Is+Python
# ============================================================================================
@app.route('/crazy/nobita', methods=['GET'])
def ask_gemini():
...
# ==============================================
    ...
    result['update_channel'] = '@ProviderBotz'
...
def not_found(error):
    return jsonify({
        ...
        'update_channel': '@ProviderBotz',
        'available_endpoints': ['/', '/crazy/nobita']
    }), 404
# ==============================================
...
if __name__ == '__main__':
    print('=' * 60)
    print('Nobita Gemini AI Flask API')
    print('UPDATE CHANNEL: @ProviderBotz')
    print('=' * 60)
    print('\nAPI Endpoints:')
    print('  GET  /           - API Information')
    print('  GET  /crazy/nobita    - Ask Nobita Gemini AI')
    print('\nExample Usage:')
